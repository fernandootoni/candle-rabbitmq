...
var readMarketPrice = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get(process.env.BITCOIN_URL)];
            case 1:
                result = _a.sent();
                data = result.data;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, Period_1.default.THIRTY_SECONDS); })];
            case 5:
                _a.sent();
                _a.label = 6;
            case 6:
